...
class Users(models.Model):
    ...
    userfirstname = models.CharField(
        db_column="userFirstName", max_length=25, blank=False, null=True
    )  # Field name made lowercase.
    userlastname = models.CharField(
        db_column="userLastName", max_length=30, blank=False, null=True
    )  # Field name made lowercase.
    useremailaddress = models.CharField(
        db_column="userEmailAddress", max_length=50, blank=False, null=True
    )  # Field name made lowercase.
...
class Sets(models.Model):
    ...
    setname = models.CharField(
        db_column="setName", max_length=100, blank=False, null=True
    )  # Field name made lowercase.
...
class Cards(models.Model):
    cardid = models.AutoField(
        db_column="cardID", primary_key=True
    )  # Field name made lowercase.
