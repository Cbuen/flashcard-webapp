...
SECRET_KEY = "django-insecure-j(_v3%(*2p1)z06znc4u!03sdw^dh=$q9!v5-$nehp+p@sl8au"
...
schema_title = {"windows": "flashcards1", "macbook": "flashcards"}


schema_passwords = {"windows": "root", "macbook": "rootroot"}
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "flashcard_app", "static"),  # Adjusted path
]
